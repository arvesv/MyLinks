...
export const LinkTableRow: React.FC<LinkTableRowProps> = ({
  ...
  return (
    <tr
      ...
      className="group hover:bg-slate-800/60 transition-colors border-b border-slate-800/40 text-xs text-slate-300"
    >
      {/* Title & Icon & Favorite */}
      <td className="py-2.5 px-3 whitespace-nowrap">
        <div className="flex items-center gap-2.5">
          ...
          <div className="w-6 h-6 rounded-md bg-slate-800 border border-slate-700/60 flex items-center justify-center p-1 text-indigo-400 flex-shrink-0">
          ...
          <a
            ...
            className="font-medium text-slate-100 hover:text-indigo-400 transition-colors flex items-center gap-1"
          >
      ...
      <td className="py-2.5 px-3 max-w-[200px] lg:max-w-[280px]">
        <div className="flex items-center gap-1.5">
          ...
          <span className="truncate font-mono text-[11px] text-slate-400 hover:text-slate-200 transition-colors" title={link.url}>
            {displayHost}
          </span>

          <button
            onClick={handleCopy}
            className="p-1 text-slate-500 hover:text-slate-300 rounded hover:bg-slate-700/60 transition-colors opacity-0 group-hover:opacity-100"
            title="Copy URL"
          >
      ...
      {/* Description */}
      <td className="py-2.5 px-3 max-w-[220px] hidden md:table-cell text-slate-400">
      ...
      <td className="py-2.5 px-3 text-center hidden lg:table-cell whitespace-nowrap">
        <span className="px-2 py-0.5 rounded-full bg-slate-800 font-mono text-[11px] text-slate-400">
          {link.click_count || 0}
        </span>
      </td>

      {/* Date Added */}
      <td className="py-2.5 px-3 text-center hidden xl:table-cell whitespace-nowrap text-slate-500 text-[11px]">
      ...
      <td className="py-2.5 px-3 text-right whitespace-nowrap">
        <div className="flex items-center justify-end gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
          <a
            ...
            rel="noopener noreferrer"
            onClick={() => onLinkClick(link)}
            className="p-1 text-slate-400 hover:text-indigo-400 rounded hover:bg-slate-700/60 transition-colors"
            title="Open link"
          >
          ...
          {isAdmin && (
            <>
              ...
              <button
                ...
                className="p-1 text-slate-400 hover:text-rose-400 rounded hover:bg-slate-700/60 transition-colors"
