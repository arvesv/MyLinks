...
export const LinkModal: React.FC<LinkModalProps> = ({
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-xl bg-slate-900 border border-slate-700/80 rounded-2xl shadow-2xl overflow-hidden my-8 animate-in fade-in zoom-in-95 duration-150"
          ...
          <div>
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 px-3 py-2 text-xs font-semibold bg-indigo-600/20 hover:bg-indigo-600/30 text-indigo-300 border border-indigo-500/30 rounded-xl transition-colors disabled:opacity-50"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3.5 py-2 text-sm bg-slate-950 border border-slate-800 focus:border-indigo-500 rounded-xl text-slate-100 placeholder-slate-500 focus:outline-none"
              />
            </div>
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-3.5 py-2 text-sm bg-slate-950 border border-slate-800 focus:border-indigo-500 rounded-xl text-slate-100 focus:outline-none"
              >
                {categories.map(c => (
